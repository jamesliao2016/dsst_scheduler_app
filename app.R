...
ui = fluidPage(
  titlePanel("DSST Student Scheduler - Prototype"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      p('This app reduces that pain by helping you to quickly schedule students into 
        ...
        p(strong('Hey!'), tags$i( ' Currently, this app prototype is only coded to run for 10th grade at DSST Stapleton, 
                       though it may work for other schools/grades. No promises...')), br(),
      
      
      h5('Step 1: Create an Excel file with student and scheduling data'),
     
       helpText('Hey! This app requires an excel (xls or xlsx) file. See the link in the directions to the right for an example file.'),
      ...
      h5('Step 2: Run the Student Scheduling Algorithm'),
      actionButton(inputId = "getlinks", label = "Run Scheduler", icon = icon("mail-forward")), br(), br(),
      ...
      downloadButton('downloadlinks','Download Schedule Data')      
      ),
    ...
    mainPanel(
      ...
      p(strong('Step 1:'), 'Using the example file in the link at the bottom of these instructions, create a file that contains 
        the necessary student data, class/section data, and any paired sections (i.e., classes that a student has to take together). 
        Crucially, please do', strong('NOT'), 
        'include any personally identifying student data (e.g. names, phone nums, or whatever). If you do,', 
        a('I will find you, and I will kill you.', href='https://media.tenor.com/images/a38b7ac02a752bd50350ca02a25faa1d/tenor.gif'), 
      ...
      p('There are three tabs in the example file. Please ensure that you:'),
        tags$ol(
          ...
          tags$li("include valid (i.e., unique) student IDs and section IDs (which you can create yourself) for the relevant
        tabs. The underlying code needs these fields in order to work properly."),
          tags$li("do NOT upload any personally identifiable student data. Remember ", 
                  a('what happens,', 
                    href='https://media.tenor.com/images/a38b7ac02a752bd50350ca02a25faa1d/tenor.gif'), ' if you do.')
           ),
      p(strong('Step 2:'), 'Upload the data file you have created with the upload button to the left.'),
      p(strong('Step 3:'), 'Click "Run Scheduler" to have the code run to attempt to schedule all students.
      ...
      p(strong('Step 4:'), 'After the students are assigned the file can be downloaded in .xlsx 
          format by clicking "Download."'),
      a('Click here to download example schedule file', 
